...
public class FuncionarioController implements Serializable {
    ...
    @EJB
    private com.app.techlogistic.controllers.FuncionarioFacade ejbFacade;
    ...
    public static class FuncionarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Funcionario) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Funcionario.class.getName());
            }
        }
